...
<div class="kanban-card show-modal-button reset-card-modal-form js-ajax-ux-request" data-toggle="modal"
    ...
    <div class="x-footer row">
        <div class="col-6 x-icons">
            ...
            <span class="x-icon text-info" data-toggle="tooltip" title="<?php echo app('translator')->get('lang.you_created_this_task'); ?>"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/tasks/components/kanban/card.blade.php ENDPATH**/ ?>