    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                ...
                <span>
                    <i class="ti-close js-toggle-side-panel" data-target="sidepanel-filter-subscriptions"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="f_date_created_start"
                                    ...
                                    placeholder="Start">
                                <input class="mysql-date" type="hidden" name="f_date_created_start"
                                    id="f_date_created_start" value="">
                            </div>
                            <div class="col-md-6">
...
<!--sidebar--><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/subscriptions/components/misc/filter.blade.php ENDPATH**/ ?>