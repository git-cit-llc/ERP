        ...
        <div class="row p-t-10" id="knowledgebase-search-field">
            <div class="col-lg-12">
                ...
                <div class="text-center p-t-5 p-b-40 m-b-30">
                    <h5 class="display-inline-block"><?php echo e(cleanLang(__('lang.get_help_from_knowledgebase'))); ?></h5> <h5 class="display-inline-block"><a href="/tickets/create">You can also open a support ticket</a></h5>
                </div>
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/kbcategories/page.blade.php ENDPATH**/ ?>