        ...
        <div>
            ...
            <span class="pull-right text-align-right">
                ...
                <?php if(config('system.settings_estimates_show_view_status') == 'yes' && auth()->user()->is_team && $bill->bill_status != 'draft' && $bill->bill_status != 'paid'): ?>
        ...
        </div><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/bill/components/elements/invoice/header-web.blade.php ENDPATH**/ ?>