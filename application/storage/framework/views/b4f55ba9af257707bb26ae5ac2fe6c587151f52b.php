...
<form class="form" id="settingsFormPaypal">
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.currency'))); ?>*
            <span class="align-middle text-themecontrast font-16" data-toggle="tooltip"
                title="<?php echo e(cleanLang(__('lang.payment_gateway_currency_code_example'))); ?>" data-placement="top"
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.paypal_ipn_url'))); ?>* 
            <span class="align-middle text-themecontrast font-16" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.paypal_api_instructions'))); ?>"
            data-placement="top"><i class="ti-info-alt"></i></span>
        </label>
        <div class="col-12">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-3 col-form-label" title="Foo"><?php echo e(cleanLang(__('lang.sandbox_mode'))); ?> 
            <span class="align-middle text-themecontrast font-16" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.sandbox_mode_info'))); ?>"
            data-placement="top"><i class="ti-info-alt"></i></span>
        </label>
    ...
    <div class="form-group form-group-checkbox row">
        ...
        <div class="col-9 p-t-5">
            ...
            <?php echo e(runtimePrechecked($settings->settings_paypal_status)); ?>>
    ...
    <div>
        ...
        <a href="https://growcrm.io/documentation/payment-gateway-paypal/"  target="_blank" class="btn btn-sm btn-info help-documentation"><i class="ti-info-alt"></i> <?php echo e(cleanLang(__('lang.help_documentation'))); ?></a>
    </div>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/settings/sections/paypal/page.blade.php ENDPATH**/ ?>