    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                ...
                <span>
                    <i class="ti-close js-toggle-side-panel" data-target="sidepanel-filter-tasks"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
...
<!--sidebar--><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/tasks/components/misc/filter-tasks.blade.php ENDPATH**/ ?>