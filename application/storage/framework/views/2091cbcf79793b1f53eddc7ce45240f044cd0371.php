    ...
    <form class="form-horizontal form-material" id="loginForm">
        ...
        <div class="form-group m-b-0">
            <div class="col-sm-12 text-center">
                ...
                <a href="<?php echo e(url('signup')); ?>" class="text-primary m-l-5 js-toggle-login-forms"
...
<?php echo $__env->make('layout.wrapperplain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/authentication/login.blade.php ENDPATH**/ ?>