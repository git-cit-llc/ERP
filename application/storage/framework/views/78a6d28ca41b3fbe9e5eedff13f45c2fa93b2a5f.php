...
<form>
        ...
        <table id="custom-fields" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10"">
            <thead>
                <tr>
                    ...
                    <th class=" w-15"><?php echo e(cleanLang(__('lang.show_task'))); ?></th>
            <th class="w-15"><?php echo e(cleanLang(__('lang.required'))); ?></th>
            ...
            <tbody id="status-td-container">
                ...
                <tr>
                    ...
                    <td class="td-checkbox">
                        ...
                        <label for="customfields_show_task_summary[<?php echo e($field->customfields_id); ?>]"></label>
                    </td>
                    <!--required-->
                    <td class="td-checkbox">
    ...
    <div class="text-right">
        <button type="submit" id="commonModalSubmitButton"
            ...
            data-url="/settings/customfields/tasks" data-loading-target="" data-ajax-type="PUT" data-type="form"
            data-on-start-submit-button="disable"><?php echo e(cleanLang(__('lang.save_changes'))); ?></button>
    </div>
</form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/settings/sections/customfields/tasks.blade.php ENDPATH**/ ?>