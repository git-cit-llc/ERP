...
<tr id="team_<?php echo e($team->id); ?>">
    ...
    <td class="team_col_action">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            <!--delete-->
            <?php if($team->primary_admin == 'no' && auth()->user()->id != $team->id): ?>
...
<!--each row--><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/team/components/table/ajax.blade.php ENDPATH**/ ?>