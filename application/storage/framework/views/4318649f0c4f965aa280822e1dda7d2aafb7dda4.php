...
<form class="form" id="settingsFormGeneral">
    ...
    <!--timezone-->
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.timezone'))); ?></label>
        <div class="col-12">
            <select class="select2-basic-with-search form-control form-control-sm"  data-allow-clear="false" id="settings_system_timezone"
                name="settings_system_timezone">
                <optgroup label="UTC">
    ...
    <!--date format-->
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.date_format'))); ?></label>
        <div class="col-12">
    ...
    <!--date pickerformat-->
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.date_picker_format'))); ?></label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.left_menu_position'))); ?></label>
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_default_leftmenu"
                ...
                <option value="open" <?php echo e(runtimePreselected('open', $settings->settings_system_default_leftmenu ?? '')); ?>>
    ...
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.stats_panel_default'))); ?></label>
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_default_statspanel"
                ...
                <option value="collapsed"
                    ...
                    <?php echo e(cleanLang(__('lang.collapsed'))); ?></option>
                <option value="open" <?php echo e(runtimePreselected('open', $settings->settings_system_default_statspanel ?? '')); ?>>
                    <?php echo e(cleanLang(__('lang.open'))); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.close_modal_windows_on_page_click'))); ?></label>
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_close_modals_body_click"
                ...
                <option value="no" <?php echo e(runtimePreselected('no', $settings->settings_system_close_modals_body_click ?? '')); ?>>
        ...
        <!--close modal onbocy click-->
        <div class="form-group row">
            <label for="example-month-input" class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.session_timeout_popup'))); ?></label>
            <div class="col-12">
                <select class="select2-basic form-control form-control-sm" id="settings_system_session_login_popup"
                    ...
                    <option value="disabled" <?php echo e(runtimePreselected('disabled', $settings->settings_system_session_login_popup ?? '')); ?>>
    ...
    <!--system language-->
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.default_language'))); ?></label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.allow_users_to_change_language'))); ?></label>
        <div class="col-12">
    ...
    <div>
        ...
        <a href="https://growcrm.io/documentation/general-settings/" target="_blank" class="btn btn-sm btn-info  help-documentation"><i class="ti-info-alt"></i> <?php echo e(cleanLang(__('lang.help_documentation'))); ?></a>
    </div>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/settings/sections/general/general.blade.php ENDPATH**/ ?>