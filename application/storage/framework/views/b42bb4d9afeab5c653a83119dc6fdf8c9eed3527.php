...
<div class="spacer row">
    ...
    <div class="col-sm-4 text-right">
        <div class="switch">
            <label>
                <input type="checkbox" class="js-switch-toggle-hidden-content" data-target="edit_project_options">
                <span class="lever switch-col-light-blue"></span>
            </label>
        </div>
    </div>
...
<?php endif; ?>
<!--/#[billing details]--><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/templates/projects/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>