    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                ...
                <span>
                    <i class="ti-close js-toggle-side-panel" data-target="sidepanel-filter-clients"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
            <div class="r-panel-body">
                ...
                <div class="buttons-block">
                    ...
                    data-url="<?php echo e(urlResource('/clients/search')); ?>"
...
<!--sidebar--><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/clients/components/misc/filter-clients.blade.php ENDPATH**/ ?>