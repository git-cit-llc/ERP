...
<form class="form" id="settingsFormStripe">
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.publishable_key'))); ?>*
            <span class="align-middle text-themecontrast font-16" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.stripe_general_info'))); ?>"
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.webhooks_url'))); ?>*
            <span class="align-middle text-themecontrast font-16" data-toggle="tooltip" 
            title="<?php echo e(cleanLang(__('lang.add_this_inside_your_dashboard'))); ?> (Stripe)"
            data-placement="top"><i class="ti-info-alt"></i></span>
        </label>
        <div class="col-12">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/settings/sections/stripe/page.blade.php ENDPATH**/ ?>