...
<form class="form">
    ...
    <div class="alert alert-info">
        ...
        <?php echo e(cleanLang(__('lang.cronjob_last_executed'))); ?>: (<?php echo e(runtimeDateAgo(config('system.settings_cronjob_last_run'))); ?>)
    </div>
    <?php else: ?>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/settings/sections/cronjobs/page.blade.php ENDPATH**/ ?>