    ...
    <div class="col-lg-12">
        ...
        <div class="form-group row dropdown-no-results-found hidden m-b-18" id="my_assigned_tasks_no_results">
            <div class="p-l-8 p-r-8">
                ...
                <span class="align-middle p-l-5" data-toggle="tooltip" title="<?php echo app('translator')->get('lang.no_tasks_assigned_to_you'); ?>"
                    data-placement="top" style="font-size:16px;"><i class="ti-info-alt font-13"></i></span>
            </div>
        </div>
    </div>
</div><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/timesheets/components/modals/record-time.blade.php ENDPATH**/ ?>