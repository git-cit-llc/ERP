...
<form class="form">
    ...
    <div class="form-group form-group-checkbox row">
        <div class="col-12 p-t-5">
            ...
            <label for="settings_estimates_show_view_status"><?php echo e(cleanLang(__('lang.show_if_client_has_opened'))); ?></label>
        </div>
    </div>

    <div>
        <!--settings documentation help-->
        <a href="https://growcrm.io/documentation/estimate-settings/"  target="_blank" class="btn btn-sm btn-info  help-documentation"><i class="ti-info-alt"></i> <?php echo e(cleanLang(__('lang.help_documentation'))); ?></a>
    </div>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/settings/sections/estimates/page.blade.php ENDPATH**/ ?>