        ...
        <div class="form-group row">
            ...
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="milestonecategory_title" name="milestonecategory_title"
                    value="<?php echo e($milestone->milestonecategory_title ?? ''); ?>">
            </div>
        </div>
    </div>

</div><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/settings/sections/milestones/modals/add-edit-inc.blade.php ENDPATH**/ ?>