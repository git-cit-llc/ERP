    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                ...
                <span>
                    <i class="ti-close js-toggle-side-panel" data-target="sidepanel-filter-tickets"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
            <div class="r-panel-body">
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-danger js-ajax-ux-request apply-filter-button"
                        data-url="<?php echo e(urlResource('/tickets/search?')); ?>"
...
<!--sidebar--><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/tickets/components/misc/filter-tickets.blade.php ENDPATH**/ ?>