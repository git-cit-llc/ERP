                ...
                <div class="col-sm-12 col-lg-9">
                    <select class="select2-basic form-control form-control-sm" id="project_template_selector"
                        ...
                        <option value="<?php echo e($template->project_id); ?>"
                            data-url="<?php echo e(url('projects/template-description?id='.$template->project_id)); ?>"
                            ...
                            data-custom-1="<?php echo e($template->project_custom_field_1); ?>"
                            data-custom-2="<?php echo e($template->project_custom_field_2); ?>"
                            data-custom-3="<?php echo e($template->project_custom_field_3); ?>"
                            data-custom-4="<?php echo e($template->project_custom_field_4); ?>"
                            data-custom-5="<?php echo e($template->project_custom_field_5); ?>"
                            data-custom-6="<?php echo e($template->project_custom_field_6); ?>"
                            data-custom-7="<?php echo e($template->project_custom_field_7); ?>"
                            data-custom-8="<?php echo e($template->project_custom_field_8); ?>"
                            data-custom-9="<?php echo e($template->project_custom_field_9); ?>"
                            data-custom-10="<?php echo e($template->project_custom_field_10); ?>"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <input type="text" class="form-control form-control-sm" id="<?php echo e($field->customfields_name); ?>"
                            ...
                            value="<?php echo e($project[$field->customfields_name] ?? ''); ?>">
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/projects/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>