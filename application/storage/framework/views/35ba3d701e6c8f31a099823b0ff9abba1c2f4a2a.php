            ...
            <tbody id="invoice-table-section-total">
                ...
                <tr class="billing-adjustment-container <?php echo e($bill->visibility_adjustment_row); ?>" id="billing-adjustment-container">
                    ...
                    <td class="p-t-15 billing-adjustment-text">
                        <span id="billing-adjustment-container-amount"><?php echo e(runtimeMoneyFormat($bill->bill_adjustment_amount)); ?></span>
                    </td>
                </tr>
...
</div><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/bill/components/elements/totals-table.blade.php ENDPATH**/ ?>