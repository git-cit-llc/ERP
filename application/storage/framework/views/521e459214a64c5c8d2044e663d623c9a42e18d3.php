<div class="setup-welcome">
    ...
    <div class="cronjob">
        ...
        <input class="col-12 form-control form-control-sm" type="text" value="<?php echo e($cronjob_path); ?>" disabled>
    </div>


    <div class="x-button m-t-20">
        <a href="<?php echo e(url('/login')); ?>" class="btn waves-effect waves-light btn-block btn-info">Go To My Dashboard</a>
    </div>


</div><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/setup/finish.blade.php ENDPATH**/ ?>