...
<div class="row">
    <div class="col-md-6">
        <div class="card card-outline-warning">
            ...
            <div class="card-body text-center">
                <div class="p-b-20"> <img class="logo-large display-inline-block" src="<?php echo e(runtimeLogoLarge()); ?>" alt="<?php echo e(cleanLang(__('lang.large_logo'))); ?>">
                </div>
                ...
                <a href="javascript:void(0)"
                    ...
                    data-toggle="modal" data-target="#commonModal" data-url="<?php echo e(url('/settings/logos/uploadlogo?logo_size=large')); ?>"
                    ...
                    data-header-extra-close-icon="visible" data-action-url="<?php echo e(url('/settings/logos/uploadlogo')); ?>"
    ...
    <div class="col-md-6">
        <div class="card card-outline-warning">
            ...
            <div class="card-body text-center">
                <div class="p-b-20"> <img class="logo-small display-inline-block" src="<?php echo e(runtimeLogoSmall()); ?>" alt="<?php echo e(cleanLang(__('lang.small_logo'))); ?>">
                </div>
                ...
                <p class="card-text text-bold font-weight-500"><?php echo e(cleanLang(__('lang.best_image_dimensions'))); ?> : (45px X
                    ...
                    <a href="javascript:void(0)"
                    class="btn btn-rounded-x btn-danger waves-effect js-ajax-ux-request reset-target-modal-form edit-add-modal-button"
                    data-toggle="modal" data-target="#commonModal" data-url="<?php echo e(url('/settings/logos/uploadlogo?logo_size=small')); ?>"
                    data-loading-target="commonModalBody" data-modal-size="modal-sm"
                    data-header-close-icon="hidden"
                    data-add-class="settings-logo"
                    data-modal-title="<?php echo e(cleanLang(__('lang.update_avatar'))); ?>" data-header-visibility="hidden"
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/settings/sections/logos/page.blade.php ENDPATH**/ ?>