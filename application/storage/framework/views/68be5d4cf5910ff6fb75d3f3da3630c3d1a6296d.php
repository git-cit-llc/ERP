...
<form class="form" id="settingsFormCurrency">
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            ...
            <select class="select2-basic form-control form-control-sm select2-preselected" id="settings_system_currency_code" data-preselected="<?php echo e($settings->settings_system_currency_code ?? ''); ?>"
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/settings/sections/currency/page.blade.php ENDPATH**/ ?>