<div class="card count-<?php echo e(@count($categories)); ?>"  id="categories-table-wrapper" data-payload="<?php echo e(request('filter_category_type')); ?>" >
    <div class="card-body">
        <div class="table-responsive">
            ...
            <table id="demo-foo-addrow" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                <thead>
                    <tr>
                        ...
                        <th class="categories_col_action"><a href="javascript:void(0)"><?php echo e(cleanLang(__('lang.action'))); ?></a></th>
                    </tr>
                </thead>
            ...
            <div>
                ...
                <a href="https://growcrm.io/documentation/category-settings/"  target="_blank" class="btn btn-sm btn-info help-documentation"><i class="ti-info-alt"></i> <?php echo e(cleanLang(__('lang.help_documentation'))); ?></a>
            </div>
        </div>
    </div>
</div><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/categories/components/table/table.blade.php ENDPATH**/ ?>