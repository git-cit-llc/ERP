...
<tr id="category_<?php echo e($category->category_id); ?>">
    <td class="categories_col_name">
        ...
        <span class="sl-icon-star text-warning p-l-5" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.system_default'))); ?>"></span>
        <?php endif; ?>
    </td>
    <td class="categories_col_created_by">
        <img src="<?php echo e(getUsersAvatar($category->avatar_directory, $category->avatar_filename, $category->category_creatorid)); ?>" alt="user"
    ...
    <td class="categories_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.delete'))); ?>" class="data-toggle-action-tooltip btn btn-outline-danger btn-circle btn-sm confirm-action-danger"
                ...
                data-ajax-type="DELETE" data-url="<?php echo e(url('/')); ?>/categories/<?php echo e($category->category_id); ?>">
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                ...
                data-action-url="<?php echo e(url('/categories/'.$category->category_id.'?filter_category_type='.$category->category_type)); ?>" data-action-method="PUT"
...
<!--each row--><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/categories/components/table/ajax.blade.php ENDPATH**/ ?>