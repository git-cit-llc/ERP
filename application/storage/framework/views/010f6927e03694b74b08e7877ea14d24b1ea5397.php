    ...
    <form class="form-horizontal form-material" id="setupForm" name="setupForm">
        ...
        <div class="x-button text-right p-t-20">
            <button class="btn waves-effect waves-light btn-info btn-extra-padding" data-button-loading-annimation="yes"
                ...
                id="continueButton" type="submit" data-url="<?php echo e(url('setup/settings')); ?>">Continue</button>
        </div>
    </form>

</div><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/setup/settings.blade.php ENDPATH**/ ?>