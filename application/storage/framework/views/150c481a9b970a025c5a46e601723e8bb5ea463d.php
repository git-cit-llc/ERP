...
<div class="display-flex flex-row topevent" id="event_<?php echo e($event->event_id); ?>">
    ...
    <div class="x-content">
        ...
        <div class="x-name clearfix">
            ...
            <?php else: ?>
                <?php echo e($event->first_name); ?> <?php echo e($event->last_name); ?>
...
<?php endif; ?><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/events/topnav.blade.php ENDPATH**/ ?>