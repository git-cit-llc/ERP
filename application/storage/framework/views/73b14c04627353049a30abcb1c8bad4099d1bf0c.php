    ...
    <td class="contacts_col_action actions_column" id="contacts_col_action_<?php echo e($contact->id); ?>">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.update_password'))); ?>"
                ...
                data-toggle="modal" data-target="#commonModal"
                data-url="<?php echo e(urlResource('/user/updatepassword?contact_id='.$contact->id)); ?>" data-loading-target="commonModalBody"
...
<!--each row--><?php /**PATH /home/x/x4power/erp.cit-llc.ru/public_html/application/resources/views/pages/contacts/components/table/ajax.blade.php ENDPATH**/ ?>